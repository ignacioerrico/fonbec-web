...
namespace Fonbec.Web.DataAccess.Migrations
{
    ...
    [Migration("20260909171041_IncreaseCompanyAndPointOfContactPhoneNumberLength")]
    partial class IncreaseCompanyAndPointOfContactPhoneNumberLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fonbec.Web.DataAccess.Entities.Assessment", b =>
                {
                    ...
                    b.Property<int?>("GreenFlagResolvedById")
                        .HasColumnType("int");

                    b.Property<DateTime?>("GreenFlagResolvedOn")
                    ...
                    b.Property<bool>("IsGreenFlagResolved")
                        .HasColumnType("bit");

                    b.Property<bool>("IsRedFlagResolved")
                        .HasColumnType("bit");
                    ...
                    b.Property<byte?>("RedFlagPriority")
                        .HasColumnType("tinyint");

                    b.Property<int?>("RedFlagResolvedById")
                        .HasColumnType("int");

                    b.Property<DateTime?>("RedFlagResolvedOn")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("GreenFlagResolvedById");

                    b.HasIndex("RedFlagResolvedById");
            ...
            modelBuilder.Entity("Fonbec.Web.DataAccess.Entities.Letter", b =>
                {
                    ...
                    b.HasIndex("PlanId", "ChapterId", "Status");
            ...
            modelBuilder.Entity("Fonbec.Web.DataAccess.Entities.Assessment", b =>
                {
                    b.HasOne("Fonbec.Web.DataAccess.Entities.FonbecWebUser", "GreenFlagResolvedBy")
                        .WithMany()
                        .HasForeignKey("GreenFlagResolvedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Fonbec.Web.DataAccess.Entities.FonbecWebUser", "RedFlagResolvedBy")
                        .WithMany()
                        .HasForeignKey("RedFlagResolvedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("GreenFlagResolvedBy");

                    b.Navigation("RedFlagResolvedBy");
                });
            ...
            modelBuilder.Entity("Fonbec.Web.DataAccess.Entities.PlannedDelivery", b =>
                {
                    ...
                    b.HasOne("Fonbec.Web.DataAccess.Entities.FonbecWebUser", "CompletedBy")
                        .WithMany()
