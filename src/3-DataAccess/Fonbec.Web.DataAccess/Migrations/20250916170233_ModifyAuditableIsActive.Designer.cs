...
namespace Fonbec.Web.DataAccess.Migrations
{
    ...
    [Migration("20250916170233_ModifyAuditableIsActive")]
    partial class ModifyAuditableIsActive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fonbec.Web.DataAccess.Entities.Student", b =>
                {
                    ...
                    b.Property<DateTime?>("SecondarySchoolSinceUtc")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("UniversitySinceUtc")
                        .HasColumnType("datetime2");
