...
using Fonbec.Web.Ui.Models.Facilitator;
...
public partial class FacilitatorUploadDocument : AuthenticationRequiredComponentBase
{
    ...
    private readonly FacilitatorUploadDocumentBindModel _bindModel = new();
    ...
    private async Task Save()
    {
        ...
        try
        {
            ...
            {
                DocumentType.Letter => await UploadLetterAsync(),
                DocumentType.ReportCard => await UploadReportCardAsync(),
                _ => await UploadOtherAsync(),
            };
    ...
    private async Task<CrudResult<long>> UploadLetterAsync()
    {
        ...
        try
        {
            ...
            return await FacilitatorUploadService.UploadLetterAsync(input, FonbecClaim.UserId);
        }
        finally
        {
    ...
    private async Task<CrudResult<long>> UploadReportCardAsync()
    {
        var files = OpenSelectedFiles();
        try
        {
            ...
            return await FacilitatorUploadService.UploadReportCardAsync(input, FonbecClaim.UserId);
        }
        finally
        {
            await DisposeFilesAsync(files);
    ...
    private async Task<CrudResult<long>> UploadOtherAsync()
    {
        var files = OpenSelectedFiles();
        try
        {
            ...
            return await FacilitatorUploadService.UploadOtherDocumentAsync(input, FonbecClaim.UserId);
        }
        finally
        {
            await DisposeFilesAsync(files);
